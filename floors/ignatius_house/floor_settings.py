...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.neighbor, 50),
        (entity_factories.hoodlem, 50),
        (entity_factories.psychoanalyist, 50),
    ]
}
bosses: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.neighbor_annie, 50),
        (entity_factories.claude_robichaux, 50)
    ]
}

floor_settings = {
    "floor_name": "ignatius_house",
    "colors": colors,
