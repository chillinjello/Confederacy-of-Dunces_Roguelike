...
colors = color.university_colors
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.student, 50),
        (entity_factories.redneck, 50),
        (entity_factories.cracker, 50),
    ],
}
bosses: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.professor_talc, 50),
        (entity_factories.greyhound_bus, 50),
    ],
}
