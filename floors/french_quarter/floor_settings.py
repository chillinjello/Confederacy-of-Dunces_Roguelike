...
colors = color.french_quarter_colors
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.sailor, 50),
        (entity_factories.fop, 50),
        (entity_factories.lady_painter, 50),
    ]
}
bosses: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.george, 50),
        (entity_factories.dorian_green, 50)
    ]
}
