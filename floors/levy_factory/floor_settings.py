...
colors = color.levy_factory_colors
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.factory_worker, 50)],
    3: [(entity_factories.office_worker, 50)],
    5: [(entity_factories.foreman, 50)],
}
bosses: Dict[int, List[Tuple[Entity, int]]] = {
    0: [
        (entity_factories.gonzoloz, 50),
        (entity_factories.mrs_levy, 50),
        (entity_factories.mr_levy, 50),
    ]
}
